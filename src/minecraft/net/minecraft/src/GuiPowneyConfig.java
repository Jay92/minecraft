...
//            GuiScreen, StringTranslate, PowneySettings, GuiSmallButton, 
//            GuiButton, KeyBinding

public class GuiPowneyConfig extends GuiScreen
{

    private GuiScreen parentScreen;
    protected String screenTitle;
    private PowneySettings options;
    private int buttonId;

    public GuiPowneyConfig(GuiScreen guiscreen, PowneySettings powneysettings)
    {
        screenTitle = "Controls";
        buttonId = -1;
        parentScreen = guiscreen;
        options = powneysettings;
    }
