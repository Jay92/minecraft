...
public class GuiScreenAddServer extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        field_35361_c = new GuiTextField(this, fontRenderer, width / 2 - 100, 76, 200, 20, field_35359_d.name);
        field_35361_c.isFocused = true;
        field_35361_c.setMaxStringLength(32);
        field_35360_b = new GuiTextField(this, fontRenderer, width / 2 - 100, 116, 200, 20, field_35359_d.host);
